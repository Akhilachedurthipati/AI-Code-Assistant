...
if DATABASE_URL is None:
    print("Testing connection: Database is DISABLED (DB_TYPE=none)")
else:
...
if DATABASE_URL is None:
    print("\nSUCCESS: Database connection disabled as requested (stateless mode).")
else:
    try:
        ...
        print(f"\nCONNECTION FAILED: {e}")
        if DB_TYPE == "sqlite":
            print("\nPlease verify that sqlite is working correctly.")
        else:
            print("\nPlease verify that:")
